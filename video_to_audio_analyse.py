...
# analyzer = SpeechAnalyzer(video_path)
# text = "Your transcribed text goes here"
...
#             scores = {
#                 "grammar": 1 - (float(grammar_mistakes) / self.max_grammar_mistakes),
#                 "fluency": float(fluency),
#                 "tone": float(tone) / self.max_tone,
#                 "voiceConfidence": float(confidence) / self.max_confidence,
#                 "speechRate": float(self.speech_rate)
#             }
