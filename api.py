...
class APIs:
    def __init__(self):
        self.half_url="http://192.168.1.20:8086/api/proCommunication" #server:192.168.1.29:8083,, java local:192.168.29.222:8086

    def get_details(self,id, max_retries=3, backoff_factor=0.3, timeout=30):
    ...
    def post_final_data(self,data, max_retries=3, backoff_factor=0.3, timeout=30):
