...
video_path=r"D:\AI Projects\AI facial analysis\videos for AI facial anlysis\10m 20mb.mp4" #grafhic card Time taken: 0.33 minutes, local cpu Time taken: 0.77 minutes
...
def post_data(data):
    url = 'http://192.168.1.7:5000/post_video'
