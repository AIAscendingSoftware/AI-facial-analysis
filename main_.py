...
def main(video_path, videoI_userId):
    ...
    end_time=time.time()
    total_VideoToAudio_time=end_time-start_time
    print(f"total_VideoToAudio_time is:", total_VideoToAudio_time)
    print('VIDEO TO AUDIO FUNCTIONALITY WORK IS ENDED')
    
    
    #converting audio to text
    start_time=time.time()
    print('AUDIO TO TEXT FUNCTIONALITY WORK IS STARTED')
    ...
    if transcribed_text is None: 
        return "There is no audio to extract, so kindly check the whether the video has english audio or not."
    end_time=time.time()
    total_audioToText=end_time-start_time
    print(f"total_audioToText is:", total_audioToText)
    print('AUDIO TO TEXT FUNCTIONALITY WORK IS ENDED')
    
    # # Gesture Analysis
    start_time=time.time()
    print('GESTURE ANALYZER FUNCTIONALITY WORK IS STARTED')
    ...
    end_time=time.time()
    total_GestureAnalyzer=end_time-start_time
    print(f"GestureAnalyzer is:", total_GestureAnalyzer)
    print('GESTURE ANALYZER FUNCTIONALITY WORK IS ENDED')


    # Speech Analysis
    start_time=time.time()
    print('SPEECH ANALYZER FUNCTIONALITY WORK IS STARTED')
    ...
    end_time=time.time()
    total_SpeechAnalyzer_time=end_time-start_time
    print(f"total_SpeechAnalyzer_time is:", total_SpeechAnalyzer_time)
    print('SPEECH ANALYZER FUNCTIONALITY WORK IS ENDED')


    start_time=time.time()
    print('TOTAL CALCULATION FUNCTIONALITY WORK IS STARTED')
